    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://aryan-pi.vercel.app/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <h2 class="mb-3 text-center fs-3 font-weight-bold">Update Job Post</h2>
                    <form action="/updateJob" method="post">
                        ...
                        <div class="mb-1">
                            ...
                            <textarea class="form-control" id="postDesc" name="postDesc" rows="2" required>${jobPost.postDesc}</textarea>
                        </div>
                        <div class="mb-1">
